...
A difficulty encountered when trying to determine allelic counts from the output of the GATK workflow for RNAseq short variant discovery arises due to positions not being reported when homozygous for the reference nucleotide.
...
This is also relattively large so will be written to the HPC.
